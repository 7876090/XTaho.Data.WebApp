...
namespace XTaho.Data.WebApp.DataAccess.PostgreSql
{
    public class Connector
    {
        ...
        public static async Task<QueryResult<T>> AddRecordAsync<T>(string queryText, T item)
        {
        ...
        public static async Task<QueryResult<T>> UpdateRecordAsync<T>(string queryText, T item)
        {
            QueryResult<T> result = new QueryResult<T>();
            string? connectionString = GetConnectionString();
            if (!string.IsNullOrEmpty(connectionString))
