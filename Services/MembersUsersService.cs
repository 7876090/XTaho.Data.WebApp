...
{  
    public class MembersUsersService
    {
        ...
        public async Task<QueryResult<MembersUsersModel>> AddMemberUserAsync(MembersUsersModel model)
        {
        ...
        public async Task<QueryResult<MembersUsersModel>> UpdateMemberUserAsync(MembersUsersModel model)
        {
